...
var bullets_scene = preload("res://EnemyBullet.tscn")
...
func shoot_left(s, hardpoint = self):
	...
	var self_position = $barrel_position.position
	var aim_position = hardpoint.rotation
	bullet.rotation = hardpoint.rotation
	bullet.position = $barrel_position.position
...
func _physics_process(delta):
	...
	self.rotation_degrees = fmod(self.rotation_degrees + rotation_speed*delta, 360.0)
